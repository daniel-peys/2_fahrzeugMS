...
//        gradle wrapper --gradle-version=7.5-milestone-1 --distribution-type=bin
...
dependencies {
    ...
    // TODO https://security.snyk.io/vuln/SNYK-JAVA-ORGJETBRAINSKOTLIN-2393744: createTempFile() und createTempFile() nicht benutzen
...
sweeney {
    ...
    enforce(mapOf("type" to "jdk", "expect" to "[16.0.2,18.0.1.1]"))
    validate()
}
