...
.Die Klasse "KundeModel" für den Datenaustausch bei GET und PUT
[plantuml,KundeModel,svg]
----
include::./KundeModel.plantuml[]
----

.Die Klasse "KundeUserModel" für den Datenaustausch bei POST
[plantuml,KundeUserModel,svg]
----
include::./KundeUserModel.plantuml[]
----
