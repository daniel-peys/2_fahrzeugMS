...
ALTER
ROLE fahrzeug SET search_path = 'fahrzeug';
...
(
  rolle ~ 'ADMIN|KUNDE|ACTUATOR|FAHRZEUG'
),
  PRIMARY KEY
(
  login_id,
...
(
  ...
  kilometerstand integer NOT NULL CHECK
(
  kilometerstand >= 0 AND kilometerstand <= 999999999
),
